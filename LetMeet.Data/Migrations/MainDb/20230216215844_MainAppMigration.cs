        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userPostion = table.Column<int>(type: "int", nullable: false),
                    profileImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    supervisorOrStudentid = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInfos_UserInfos_supervisorOrStudentid",
                        column: x => x.supervisorOrStudentid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInfos_supervisorOrStudentid",
                table: "UserInfos",
                column: "supervisorOrStudentid");
        }
